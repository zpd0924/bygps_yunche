//
//  BYMyWaitCheckWorkOrderController.m
//  BYGPS
//
...
@interface BYMyWaitCheckWorkOrderController ()
@property(nonatomic,assign) BOOL isHeader;
@property(nonatomic,assign) NSInteger currentPage;
@property (nonatomic,strong) NSMutableArray *dataSource;
@end

@implementation BYMyWaitCheckWorkOrderController
...
-(void)loadData{
    ...
    [BYSendWorkHttpTool POSTOrderListParams:dict success:^(id data) {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (weakSelf.myWaitCheckWorkBlock) {
                weakSelf.myWaitCheckWorkBlock(weakSelf.dataSource.count);
            }
