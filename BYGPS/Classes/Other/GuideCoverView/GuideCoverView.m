...
//-(instancetype)initWithItems:(NSArray *)items touchOriginYScale:(CGFloat)touchOriginYScale
//{
//    if (self = [super init]) {
//        self.ItemArr = items.mutableCopy;
//        self.frame = [UIScreen mainScreen].bounds;
...
//        
//        button.frame = CGRectMake(0, self.bounds.size.height * (CGFloat)touchOriginYScale, self.bounds.size.width, 100);
