...
-(void)setUserInfo:(NSDictionary *)userInfo{
    ...
    if ([self.userInfo[@"aps"][@"messageType"] integerValue] == 1) {
        self.content_label.text = self.userInfo[@"aps"][@"alert"];
    }else{
//        self.content_label.text = self.userInfo[@"aps"][@"alert"][@"alarmTypeStr"];
        self.content_label.text = self.userInfo[@"aps"][@"alert"];
    }
    ...
    self.time_label.hidden = self.isIos10 ? NO : YES;
    self.nowLabel.hidden = self.isIos10 ? YES : NO;
