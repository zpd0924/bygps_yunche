...
//        _maxHeight += 4;
        ...
        for (NSInteger i = 0; i<5; i++) {
            ...
            textLayer.frame = CGRectMake(self.originSize.x - be - 3, CGRectGetHeight(self.frame) - _originSize.y -height - 5, be, 30);
...
//            CGFloat wid =  count * _columnWidth;
            ...
            textLayer.frame = CGRectMake( i * (count * _columnWidth + _typeSpace) + _typeSpace+5, CGRectGetHeight(self.frame) - _originSize.y+5,wid, 30);
