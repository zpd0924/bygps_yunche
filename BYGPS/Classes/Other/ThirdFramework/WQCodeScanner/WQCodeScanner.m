...
//    lightTipLabel.by_x = 0;
//    lightTipLabel.by_y = scanCropView.by_height - 20;
//    lightTipLabel.by_width = scanCropView.by_width;
    lightTipLabel.textColor = [UIColor whiteColor];
//    [lightTipLabel sizeToFit];
    [scanCropView addSubview:lightTipLabel];
    
    [lightBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(scanCropView);
